...
import dao.databaseDAO.MedicoDAODB;
...
// Convert the result to a username-password-pair when the login button is clicked.
    ...
    public void initialize(URL location, ResourceBundle resources) {
        choiceEspecialidad.setItems(FXCollections.observableList(espRepo.readAll()));
        ...
        comboEspecialidad.setItems(FXCollections.observableArrayList(espRepo.readAll()));
