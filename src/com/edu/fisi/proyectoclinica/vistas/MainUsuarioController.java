...
import dao.databaseDAO.EspecialidadesDAODB;
import dao.databaseDAO.CitaDAODB;
...
import dao.factoriaDAO.FactoriaDAO;
...
public class MainUsuarioController extends Ventana implements Initializable {
    ...
    @FXML
    private TableColumn<PacienteTO, String> columFechaNac;
...
//            double seg2 = idk1 / 1000000000.0;
            ...
            alert.setTitle(null);
            alert.setHeaderText(null);
            alert.setContentText("No hay base de datos de pacientes");
            alert.showAndWait();
            txtBuscarDNI.setText("");
            e.printStackTrace();
        }
...
//        );
        ...
        //columFechaNac.setCellValueFactory(new PropertyValueFactory<>("fecha_nac"));
